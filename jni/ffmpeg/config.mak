...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix='D:/work/workspace2/test_ffmpeg/jni/ffmpeg/android/arm' --enable-shared --disable-static --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-doc --disable-symver --cross-prefix='d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-' --target-os=linux --arch=arm --enable-cross-compile --sysroot='d:/ndk/android-ndk-r9/platforms/android-9/arch-arm/' --extra-cflags='-Os -fpic -marm' --extra-ldflags=
prefix=D:/work/workspace2/test_ffmpeg/jni/ffmpeg/android/arm
...
ARCH=arm
CC=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
CXX=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-g++
AS=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-ranlib
STRIP=d:/ndk/android-ndk-r9/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=d:/ndk/android-ndk-r9/platforms/android-9/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=   --sysroot=d:/ndk/android-ndk-r9/platforms/android-9/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
